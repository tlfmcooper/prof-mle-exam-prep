-- Update study_plans table to persist user study plans across devices
-- This drops the old table structure and recreates it with the correct schema
...
CREATE TABLE study_plans (
  ...
  UNIQUE(user_id) -- One plan per user, updates replace old plan
);
